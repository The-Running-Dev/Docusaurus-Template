...
export default function NotFound(): React.JSX.Element {
  ...
  return (
    <Layout
      title="404 - Page Not Found (But We Found Excuses!)"
          ...
          <div className="col col--10 col--offset-1">
            ...
            >
              <div className="card__header">
                ...
                <p>
                  Here's why your page is missing (updated every 3 seconds):
                </p>
              </div>
                ...
                <div className="card shadow--tl">
                  ...
                  <div className="card__body">
                    ...
                    <div className="button-group button-group--block">
                      ...
                      <Link to="/demos" className="button button--secondary">
                        🎮 Try Demos
                      </Link>
                    </div>
                  </div>
              ...
              <div className="card__body">
                <div className="row">
                  <div className="col col--6">
                    ...
                    <ul>
                      <li>
                        Turn it off and on again (the internet, not your
                        computer)
                      </li>
                      <li>
            ...
            >
              ...
              <p>
                If this error page brought you joy, imagine how amazing our
                actual content is! While you're here, why not check out our{' '}
              ...
              >
                ...
                {Math.floor(Math.random() * 10000) + 1000}th person to visit
                this 404 page today! 🎉 (This number is completely made up)
              </p>
            </div>
